# app.py (تم إزالة دعم Node.js بالكامل)
import os
import json
import re
import subprocess
...
# ============== كشف الملف الرئيسي (Python فقط) ==============
def detect_main_file(srv_path: str) -> str:
    """يكشف ملف التشغيل الرئيسي تلقائياً (Python فقط)"""
...
# ============== تثبيت تلقائي للمكتبات (Python فقط) ==============
